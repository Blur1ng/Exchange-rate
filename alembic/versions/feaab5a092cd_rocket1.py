...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_Rocket_zabrannyyX'), 'Rocket', ['zabrannyyX'], unique=False)
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('Rocket', sa.Column('endX', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
    op.add_column('Rocket', sa.Column('end_price', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
    op.add_column('Rocket', sa.Column('start_price', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
